 ...
 * 
 * Mapeia documentos para tipos TypeScript da aplicação.
 * 
...
export class DocumentMapperService {
  ...
  /**
   * Mapeia um documento para tipo da aplicação
   * 
   * @param doc Documento
  ...
  /**
   * Mapeia NF-e para aplicação
   */
  private mapNFe(doc: any): NotaFiscal {
    return {
  ...
  /**
   * Mapeia CF-e para aplicação
   */
  private mapCFe(doc: any): CupomFiscal {
    return {
      id: doc._id || doc.CHV_NFE,
      numero: doc.NUM_DOC || '',
      serie: doc.SER || '',
  ...
  /**
   * Mapeia CT-e para aplicação
   */
  private mapCTe(doc: any): ConhecimentoTransporte {
    return {
      id: doc._id || doc.CHV_NFE,
      numero: doc.NUM_DOC || '',
      serie: doc.SER || '',
