...
export default function TestRealRequest() {
  ...
  const testDirectHTTPS = async () => {
    ...
    try {
      ...
      const response = await axios.get('https://apinfe.revio.digital/api/WebView/Consultar', {
        params: {
          host: '10.0.0.8',
          collection: 'tbl_nfe_100',
          database: 'C67624577000145',
  ...
  const testViaProxy = async () => {
    ...
    try {
      ...
      const response = await axios.get('/api/WebView/Consultar', {
        params: {
          host: '10.0.0.8',
          collection: 'tbl_nfe_100',
          database: 'C67624577000145',
  ...
  const testWithCURL = () => {
    const curlCommand = `curl -X GET "http://apinfe.revio.digital/api/WebView/Consultar?host=10.0.0.8&collection=tbl_nfe_100&database=C67624577000145&pg=1&size=5&dtIni=2024-11-01&dtFin=2024-11-27" \\
