...
import AnalyticsAPI from './pages/AnalyticsAPI'
import AnalyticsAPIAgregado from './pages/AnalyticsAPIAgregado'
import AnalyticsAPITeste120Dias from './pages/AnalyticsAPITeste120Dias'
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/" element={<Layout />}>
            ...
            <Route path="analytics-api" element={<AnalyticsAPI />} />
            <Route path="analytics-api-agregado" element={<AnalyticsAPIAgregado />} />
            <Route path="analytics-teste-120dias" element={<AnalyticsAPITeste120Dias />} />
