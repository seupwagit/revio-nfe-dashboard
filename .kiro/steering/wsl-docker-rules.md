...
```bash
# Build da imagem
wsl -d Ubuntu bash -c "cd /mnt/c/Drive/Projetos/revio-nfe-dashboard && docker build -t test-image ."

# Testar container
wsl -d Ubuntu bash -c "cd /mnt/c/Drive/Projetos/revio-nfe-dashboard && docker run -p 3000:3000 test-image"
