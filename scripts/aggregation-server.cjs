...
// Configuração MongoDB (lê do .env)
const MONGODB_URI = process.env.VITE_MONGODB_CONNECTION_STRING || 'mongodb://revio:zaqwsx2001@10.0.0.8:27017/?authMechanism=SCRAM-SHA-256&authSource=admin&directConnection=true'
const DB_NAME = process.env.VITE_DB_DATABASE || 'C67624577000145'

console.log('🔧 Configuração:')
console.log('   MongoDB URI:', MONGODB_URI.replace(/\/\/.*:.*@/, '//***:***@')) // Oculta senha no log
...
// Iniciar servidor
const PORT = process.env.VITE_AGGREGATION_PORT || 3000
